defmodule RegexFormatterTest do
  ...
  describe "RegexFormatter" do
    ...
    test "Presets.trim_sigil_whitespace()" do
      for ex <- [".ex", ".exs"] do
        assert(
          RegexFormatter.format(input(), [
            extension: ex,
            regex_formatter: [
              [
                extensions: [".ex", ".exs"],
                replacements: [
                  RegexFormatter.Presets.trim_sigil_whitespace([:u]),
                ]
              ]
            ]
          ]) ==
    ...
    test "Presets.trim_sigil_whitespace(collapse: false)" do
      for ex <- [".ex", ".exs"] do
        assert(
          RegexFormatter.format(input(), [
            extension: ex,
            regex_formatter: [
              [
                extensions: [".ex", ".exs"],
                replacements: [
                  RegexFormatter.Presets.trim_sigil_whitespace([:u], collapse: false),
                ]
              ]
            ]
          ]) ==
    ...
    test "Presets.trim_sigil_whitespace(collapse: true)" do
      for ex <- [".ex", ".exs"] do
        assert(
          RegexFormatter.format(input(), [
            extension: ".ex",
    ...
    test "Presets.do_on_separate_line_after_multiline_signature()" do
      for ex <- [".ex", ".exs"] do
        assert(
          RegexFormatter.format(input(), [
            extension: ".exs",
